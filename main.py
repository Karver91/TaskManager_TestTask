...
from repository.file_manager import JSONFileManager, BaseFileManager, CSVFileManager
...
def main():
    ...
    repository: BaseFileManager = CSVFileManager(model=Task, data_path=settings.data_file_path)
