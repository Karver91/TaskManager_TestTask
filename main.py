...
from repository.file_manager import JSONFileManager, FileManagerInterface, CSVFileManager
...
def main():
    ...
    repository: FileManagerInterface = CSVFileManager(model=Task, data_path=settings.data_file_path)
